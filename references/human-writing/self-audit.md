...
Read the complete draft once without editing, then answer for every scene. Use the root `assets/self-narrative-closure-audit-v1.template.json`; prose locations and state changes are required evidence, not optional notes.
