...
SEGMENT_MAP_SCHEMA = "NATURAL_PROSE_DETECTOR_SEGMENT_MAP_V1"
...
def _validate_segment_map(
    ...
    *,
    ...
    try:
        ...
        return False
    if not isinstance(payload, dict) or payload.get("schema") != SEGMENT_MAP_SCHEMA:
...
def _validate_detector_evidence(
    ...
    *,
    ...
    if segment_binding is not None:
        segment_map_valid = _validate_segment_map(
            segment_binding,
